...
describe('JobContext', () => {
  ...
  jest.mock('@orchestra-engine/redis', () => ({ redis: mockRedis, RedisKeys: { jobProgress: (id: string) => `job:progress:${id}`, jobLogs: (id: string) => `job:logs:${id}` }, RedisTTL: { JOB_STATE: 604800 } }));
